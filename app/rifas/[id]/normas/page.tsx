  ...
  return <main className="min-h-screen bg-white px-7 py-8 text-zinc-950 sm:px-14 print:px-0 print:py-0">
    ...
    <section className="terms-sheet mx-auto max-w-4xl">
      <div className="flex items-start justify-between gap-6">
        <div className="no-print flex items-center gap-3"><a href={raffle?.slug ? `/rifas/${raffle.slug}` : 'javascript:history.back()'} className="inline-flex items-center gap-2 text-2xl font-black uppercase text-black">
