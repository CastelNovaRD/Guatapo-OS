  ...
  return <header className="bg-zinc-950 px-4 py-3 text-white">
    <div className="mx-auto grid max-w-[1058px] grid-cols-[1fr_auto] items-center gap-3 sm:grid-cols-[1fr_auto_1fr]">
      ...
      <div className="flex items-center justify-end gap-2 sm:gap-3">
        <a href={instagramUrl} target="_blank" rel="noreferrer" aria-label="Instagram" className="grid h-9 w-9 place-items-center rounded-lg bg-white sm:h-10 sm:w-10"><img src="/brands/instagram.svg" alt="Instagram" className="h-7 w-7 object-contain" /></a>
        <a href={whatsappUrl} target="_blank" rel="noreferrer" aria-label="WhatsApp" className="grid h-9 w-9 place-items-center rounded-lg bg-white sm:h-10 sm:w-10"><img src="/brands/whatsapp.svg" alt="WhatsApp" className="h-7 w-7 object-contain" /></a>
...
function ContactCards({ raffle, whatsappUrl, instagramUrl }: { raffle: Raffle; whatsappUrl: string; instagramUrl: string }) { return <section className="space-y-8 text-center"><div><h2 className="text-4xl font-black">Tienes algun<br/>Inconveniente ?</h2><a href={whatsappHelpHref(whatsappUrl, raffle, 'inconveniente')} target="_blank" rel="noreferrer" className="mt-4 inline-flex rounded-xl bg-emerald-500 px-5 py-2 text-2xl font-black text-black">Escribenos !!</a></div><div><h2 className="text-3xl font-black uppercase">Siguenos!!</h2><p className="text-2xl">@guatapord</p><a href={instagramUrl} target="_blank" rel="noreferrer" className="mt-2 inline-flex h-16 w-16 items-center justify-center rounded-xl bg-white shadow"><img src="/brands/instagram.svg" alt="Instagram" className="h-12 w-12 object-contain" /></a></div></section> }
